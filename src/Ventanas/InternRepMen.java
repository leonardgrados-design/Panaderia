...
/**
 * Ventana interna para visualizar el reporte de ventas del mes actual.
 */
public class InternRepMen extends JInternalFrame {
    ...
    public InternRepMen() {
        ...
        this.setTitle("Reporte de Ventas - Corte Mensual");
    ...
    private void iniciarComponentes() {
        // --- TÍTULO ---
        lblTitulo = new JLabel("REPORTE DE VENTAS MENSUAL", SwingConstants.CENTER);
        ...
        // --- SECCIÓN DE TOTALES ---
        lblTotalTexto = new JLabel("TOTAL MENSUAL:");
        ...
        lblTotalMonto.setForeground(new Color(255, 102, 0)); // Naranja para diferenciar
    ...
    private void cargarDatos() {
        // 1. Llenar la tabla con el método MENSUAL del controlador
        DefaultTableModel modelo = controlador.obtenerReporteMensual();
        ...
        // 2. Calcular y mostrar el total MENSUAL
        float total = controlador.obtenerTotalMensual();
